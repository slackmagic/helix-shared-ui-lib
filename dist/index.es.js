...
import React__default, { useContext, useState, useEffect, Component, Children, isValidElement, cloneElement } from 'react';
import { jsx, Fragment as Fragment$3, jsxs } from 'react/jsx-runtime';
...
var AuthContext = React__default.createContext(contextDefaultValues);
...
var PrivateRoute = function (props) {
    ...
    return (jsx(Route, __assign({}, rest, { render: function (routeProps) {
            return isAuthenticated ? (jsx(Component, __assign({}, routeProps), void 0)) : (jsx(Redirect, { to: {
                    pathname: "/login",
...
function Login() {
    ...
    return (jsx(Fragment$3, { children: jsx(ThemeProvider, __assign({ theme: mainTheme }, { children: jsxs("form", __assign({ className: classes.form, noValidate: true }, { children: [jsx(TextField$1, { variant: "outlined", margin: "normal", required: true, fullWidth: true, id: "login", label: "Login", name: "login", autoComplete: "login", autoFocus: true, onChange: function (e) { return setLogin(e.target.value); }, onKeyPress: function (e) { return handleKeyPress(e); } }, void 0),
                    jsx(TextField$1, { variant: "outlined", margin: "normal", required: true, fullWidth: true, name: "password", label: "Mot de passe", type: "password", id: "password", autoComplete: "current-password", onChange: function (e) { return setPassword(e.target.value); }, onKeyPress: function (e) { return handleKeyPress(e); } }, void 0),
...
export { AuthContext, AuthProvider, HelixAuth, HelixService, HelixUserAPI, Login, mainTheme as MainTheme, PrivateRoute, useAuth };
