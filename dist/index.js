...
var AuthContext = React__default['default'].createContext(contextDefaultValues);

var useAuth = function () {
    return React.useContext(AuthContext);
};

function e$3(e){this.message=e;}e$3.prototype=new Error,e$3.prototype.name="InvalidCharacterError";var r$3="undefined"!=typeof window&&window.atob&&window.atob.bind(window)||function(r){var t=String(r).replace(/=+$/,"");if(t.length%4==1)throw new e$3("'atob' failed: The string to be decoded is not correctly encoded.");for(var n,o,a=0,i=0,c="";o=t.charAt(i++);~o&&(n=a%4?64*n+o:o,a++%4)?c+=String.fromCharCode(255&n>>(-2*a&6)):0)o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(o);return c};function t$1(e){var t=e.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw "Illegal base64url string!"}try{return function(e){return decodeURIComponent(r$3(e).replace(/(.)/g,(function(e,r){var t=r.charCodeAt(0).toString(16).toUpperCase();return t.length<2&&(t="0"+t),"%"+t})))}(t)}catch(e){return r$3(t)}}function n$3(e){this.message=e;}function o(e,r){if("string"!=typeof e)throw new n$3("Invalid token specified");var o=!0===(r=r||{}).header?0:1;try{return JSON.parse(t$1(e.split(".")[o]))}catch(e){throw new n$3("Invalid token specified: "+e.message)}}n$3.prototype=new Error,n$3.prototype.name="InvalidTokenError";

var API_ACCESS_TOKEN = "1234567890-ABCDEFGH";
var HelixService = /** @class */ (function () {
    function HelixService() {
    }
    HelixService.prototype.get = function (url, callback) {
        var _this = this;
        return fetch(url, {
            method: "GET",
            headers: {
    ...
    HelixService.prototype.getWithAuth = function (url, token, callback) {
        var _this = this;
        return fetch(url, {
            method: "GET",
            headers: {
    ...
    HelixService.prototype.postWithAuth = function (url, token, json, callback) {
        var _this = this;
        return fetch(url, {
            method: "POST",
            headers: {
    ...
    HelixService.prototype.put = function (url, json, callback) {
        var _this = this;
        return fetch(url, {
            method: "PUT",
            headers: {
    ...
    HelixService.prototype.putWithAuth = function (url, token, json, callback) {
        var _this = this;
        return fetch(url, {
            method: "PUT",
            headers: {
    ...
    HelixService.prototype.deleteWithAuth = function (url, token, callback) {
        var _this = this;
        return (fetch(url, {
            method: "DELETE",
            headers: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, sessionStorage.setItem(key, value)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        console.error("sessionStorage error: " + error_1.message);
                        return [3 /*break*/, 3];
...
function compilePath(path) {
  if (cache$3[path]) return cache$3[path];
  var generator = pathToRegexp_1.compile(path);

  if (cacheCount < cacheLimit) {
    cache$3[path] = generator;
    cacheCount++;
  }
...
if (process.env.NODE_ENV !== "production") {
  Route.propTypes = {
    ...
    component: function component(props, propName) {
      if (props[propName] && !reactIs$2.isValidElementType(props[propName])) {
...
var PrivateRoute = function (props) {
    ...
    return (jsxRuntime.jsx(Route, __assign({}, rest, { render: function (routeProps) {
            return isAuthenticated ? (jsxRuntime.jsx(Component, __assign({}, routeProps), void 0)) : (jsxRuntime.jsx(Redirect, { to: {
                    pathname: "/login",
...
function y$1(a){if("object"===typeof a&&null!==a){var t=a.$$typeof;switch(t){case b$1:switch(a=a.type,a){case d$1:case f$1:case e$1:case l$1:case m$1:return a;default:switch(a=a&&a.$$typeof,a){case h$1:case k$1:case p$1:case n$1:case g$1:return a;default:return t}}case c$1:return t}}}var z$1=g$1,A$1=b$1,B$1=k$1,C$1=d$1,D$1=p$1,E$1=n$1,F$1=c$1,G$1=f$1,H$1=e$1,I$1=l$1;var ContextConsumer$1=h$1;var ContextProvider$1=z$1;var Element$2=A$1;var ForwardRef$1=B$1;var Fragment$1=C$1;var Lazy$1=D$1;var Memo$1=E$1;var Portal$2=F$1;var Profiler$1=G$1;var StrictMode$1=H$1;
...
var Paper$1 = withStyles(styles$m, {
  name: 'MuiPaper'
})(Paper);
...
var SimpleBackdrop = /*#__PURE__*/React__namespace.forwardRef(function SimpleBackdrop(props, ref) {
  ...
  return open ? /*#__PURE__*/React__namespace.createElement("div", _extends({
    ...
    style: _extends({}, styles$i.root, invisible ? styles$i.invisible : {}, other.style)
  })) : null;
});
...
Input.muiName = 'Input';
var Input$1 = withStyles(styles$9, {
  name: 'MuiInput'
})(Input);
...
function Login() {
    ...
    var _a = React.useState(""), login = _a[0], setLogin = _a[1];
    var _b = React.useState(""), password = _b[0], setPassword = _b[1];
    var _c = React.useState(true), isButtonDisabled = _c[0], setIsButtonDisabled = _c[1];
    React.useEffect(function () {
        setIsButtonDisabled(login.trim().length === 0 || password.trim().length === 0);
    }, [login, password]);
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(ThemeProvider, __assign({ theme: mainTheme }, { children: jsxRuntime.jsxs("form", __assign({ className: classes.form, noValidate: true }, { children: [jsxRuntime.jsx(TextField$1, { variant: "outlined", margin: "normal", required: true, fullWidth: true, id: "login", label: "Login", name: "login", autoComplete: "login", autoFocus: true, onChange: function (e) { return setLogin(e.target.value); }, onKeyPress: function (e) { return handleKeyPress(e); } }, void 0),
                    jsxRuntime.jsx(TextField$1, { variant: "outlined", margin: "normal", required: true, fullWidth: true, name: "password", label: "Mot de passe", type: "password", id: "password", autoComplete: "current-password", onChange: function (e) { return setPassword(e.target.value); }, onKeyPress: function (e) { return handleKeyPress(e); } }, void 0),
                    jsxRuntime.jsx(Button$1, __assign({ fullWidth: true, variant: "contained", color: "primary", className: classes.submit, disabled: isButtonDisabled, onClick: function () { return handleLogin(); } }, { children: "Se connecter" }), void 0)] }), void 0) }), void 0) }, void 0));
}

exports.AuthContext = AuthContext;
exports.AuthProvider = AuthProvider;
exports.HelixAuth = HelixAuth;
exports.HelixService = HelixService;
exports.HelixUserAPI = HelixUserAPI;
exports.Login = Login;
exports.MaintTheme = mainTheme;
